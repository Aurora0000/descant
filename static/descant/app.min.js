...
value:"zh_CN"}]});var tagApp=angular.module("descant.services.tagservice",["descant.config","ngResource"]);tagApp.factory("Tag",["$resource","$cacheFactory","descantConfig",function(a,b,c){return a(c.backend+"/api/v0.1/tags/",{},{query:{method:"GET",cache:!0,isArray:!0}})}]);
