...
e.post.contents;c.title_edited=e.post.title;for(var a=0;a<e.post.tag_ids.length;a++)alert(e.post.tag_ids[a]),f.getTagInfo(e.post.tag_ids[a]).then(function(a){null!=a&&c.tag_ids_edited.push(a)})};this.editSubmit=function(){for(var d=c.tag_ids_edited,e=0;e<d.length;e++)d[e]=parseInt(d[e].id);var f=this;b.put(a.backend+"/api/v0.1/topics/"+c.topicId+"/",{title:c.title_edited,contents:c.contents_edited,tag_ids:d}).success(function(a){f.edit()})};this.deleteObj=function(){b["delete"](a.backend+"/api/v0.1/topics/"+
c.topicId+"/").success(function(a){d.path("/")})};this.loadTags=function(){return f.getAllTags()}}],controllerAs:"topic"}}]);
