...
newPostApp.directive("newPostBox",["$location",function(d){return{restrict:"E",templateUrl:"templates/posts/new-post-box.html",controller:["tokenService","$rootScope","$http","descantConfig",function(c,f,e,b){this.submitting=!1;this.auth=c.authenticated;var a=this;f.$on("auth:statusChange",function(){a.auth=c.authenticated});this.showNTP=!1;this.toggleNTP=function(){this.showNTP=1==this.showNTP?!1:!0};this.addReply=function(a,c){this.submitting=!0;var g=this;e.post(b.backend+"/api/v0.1/topics/"+c+
"/replies/",{contents:a}).success(function(a){g.submitting=!1;d.path("/topic/"+c);g.toggleNTP();f.$broadcast("topic:refresh")}).error(function(a){g.submitting=!1;alert("Error!")})}}],controllerAs:"newPostCtrl"}}]);var newTopicApp=angular.module("descant.directives.newtopic",["descant.config","descant.services.tokenservice"]);
newTopicApp.directive("newTopicBox",["$location",function(d){return{restrict:"E",templateUrl:"templates/topics/new-topic-box.html",controller:["tokenService","$rootScope","$http","descantConfig",function(c,f,e,b){this.auth=c.authenticated;this.submitting=!1;var a=this;f.$on("auth:statusChange",function(){a.auth=c.authenticated});this.showNTP=!1;this.toggleNTP=function(){this.showNTP=1==this.showNTP?!1:!0};this.addTopic=function(a,c,g){this.submitting=!0;var l;for(l=0;l<g.length;l++)g[l]=parseInt(g[l].id);
var m=this;e.post(b.backend+"/api/v0.1/topics/",{title:a,contents:c,tag_ids:g}).success(function(a){m.submitting=!1;d.path("/topics");m.toggleNTP();f.$broadcast("topics:refresh")}).error(function(a){m.submitting=!1;alert("Error!")})};this.loadTags=function(){return e.get(b.backend+"/api/v0.1/tags/")}}],controllerAs:"newTopicCtrl"}}]);tagApp=angular.module("descant.directives.taglist",["descant.config","descant.services.tagservice"]);
