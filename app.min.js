...
tagApp.service("tagService",["$http","$q","$rootScope","descantConfig",function(c,d,b,e){this.tags=[];this.fetched=!1;this.getTagInfo=function(c){var a=this;if(0==this.fetched)return this.fetch().then(function(h){return a.tags[c-1]});var b=this.tags[c-1];return d(function(a,c){a(b)})};this.getAllTags=function(){if(0==this.fetched){var c=this;return this.fetch().then(function(a){return c.tags})}var a=this.tags;return d(function(c,h){c(a)})};this.fetch=function(){var b=this;return c.get(e.backend+"/api/v0.1/tags/").then(function(a){b.tags=
...
topicViewApp.directive("topicFirstpost",["descantConfig",function(c){return{restrict:"E",templateUrl:"templates/topics/topic-firstpost.html",controller:["$http","$scope","tagService","tokenService",function(d,b,e,f){this.editing=!1;var a=this;a.loaded=!1;var g=d.get(c.backend+"/api/v0.1/topics/"+b.topicId+"/");g.success(function(d){a.post=d;a.loaded=!0;document.title=a.post.title+" | "+c.forumName;b.user=null!=f.user?f.user.data.id:-1});g.error(function(b){a.loaded=!0;a.error=!0});this.edit=function(){this.editing=
!this.editing;b.tag_ids_edited=[];b.contents_edited=a.post.contents;b.title_edited=a.post.title;for(var c=0;c<a.post.tag_ids;c++)e.getTagInfo(a.post.tag_ids[c]).then(function(a){null!=a&&b.tag_ids_edited.push(a)})};this.editSubmit=function(){for(var a=b.tag_ids_edited,e=0;e<a.length;e++)a[e]=parseInt(a[e].id);var f=this;d.put(c.backend+"/api/v0.1/topics/"+b.topicId+"/",{title:b.title_edited,contents:b.contents_edited,tag_ids:a}).success(function(a){f.edit()})};this.loadTags=function(){return e.getAllTags()}}],
controllerAs:"topic"}}]);
